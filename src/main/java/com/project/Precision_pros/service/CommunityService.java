...
//        communityMemberRepository.save(member);
	...
	public List<CommunityResponse> getCommunitiesInvolved(Long userId) {
		List<Community> communities = communityMemberRepository.findCommunitiesByUserId(userId);
	...
	public String joinCommunity(Long string, User user) {
		Community community = communityRepository.findByCommunityCode(string)
				.orElseThrow(() -> new RuntimeException("Community not found"));

		boolean alreadyJoined = communityMemberRepository.existsByUser_IdAndCommunity_CommunityCode(user.getId(),
				string);
		if (alreadyJoined) {
